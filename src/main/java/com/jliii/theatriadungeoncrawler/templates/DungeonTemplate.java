...
public class DungeonTemplate {
    ...
    public enum DungeonType {
        ...
        STONE(new Material[]{Material.COBBLESTONE, Material.MOSSY_COBBLESTONE, Material.STONE, Material.CRACKED_STONE_BRICKS}),
        NETHER(new Material[]{Material.NETHERRACK, Material.CRIMSON_NYLIUM, Material.BASALT}),
        DESERT(new Material[]{Material.SANDSTONE, Material.CHISELED_SANDSTONE, Material.CUT_SANDSTONE}),
        OCEAN(new Material[]{Material.PRISMARINE, Material.PRISMARINE_BRICKS, Material.DARK_PRISMARINE}),
        END(new Material[]{Material.END_STONE, Material.END_STONE_BRICKS, Material.PURPUR_BLOCK}),
